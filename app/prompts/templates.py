...
ATTENDANCE_PROMPT = """Based on the following attendance data for student {student_id}, answer their question clearly.
Attendance Data:
{attendance_data}
...
RESULTS_PROMPT = """Based on the following academic results for student {student_id}, answer their question clearly.
Academic Results:
{results_data}
...
COURSE_PROMPT = """Based on the following course and timetable data for student {student_id}, answer their question clearly.
Course Data:
{course_data}
